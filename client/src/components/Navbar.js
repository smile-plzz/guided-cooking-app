    ...
    <nav className="fixed top-0 w-full z-50 flex justify-between items-center py-4 px-8 bg-white/80 text-text shadow-md dark:bg-gray-800/80 backdrop-blur-md border-b border-gray-200 dark:border-gray-700">
      ...
      <div className="flex items-center gap-4">
        <button
          ...
          className="px-4 py-2 border-none rounded-full cursor-pointer text-base transition-colors duration-300 bg-[var(--secondary)] text-[var(--text-color)] dark:bg-[var(--background-light)] dark:text-[var(--text-color)] dark:hover:bg-[var(--background-hover)] flex items-center justify-center gap-2 font-inter"
        >
          {darkMode ? (
